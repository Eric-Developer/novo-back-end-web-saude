...
operatingHoursRouter.post("/operating-hours", async (req: Request, res: Response) => {
    try {
        const data = req.body;
...
operatingHoursRouter.get("/operating-hours/health-unit/:id", async (req: Request, res: Response) => {
    try {
        const healthUnitId = parseInt(req.params.id, 10);
        const operatingHours = await operatingHoursService.getByHealthUnitId(healthUnitId);
...
operatingHoursRouter.put("/operating-hours/:id", async (req: Request, res: Response) => {
    try {
...
operatingHoursRouter.delete("/operating-hours/:id", async (req: Request, res: Response) => {
    try {
        const id = parseInt(req.params.id, 10);
